...
import (
	...
	identity "github.com/aws/amazon-vpc-resource-controller-k8s/pkg/identity"
...
func (m *MockHandler) HandleCreate(arg0 int, arg1 *v1.Pod, arg2 ...identity.Allocation) (reconcile.Result, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
	}
	ret := m.ctrl.Call(m, "HandleCreate", varargs...)
...
func (mr *MockHandlerMockRecorder) HandleCreate(arg0, arg1 interface{}, arg2 ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{arg0, arg1}, arg2...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "HandleCreate", reflect.TypeOf((*MockHandler)(nil).HandleCreate), varargs...)
}
